...
/**
 * Unsubscribes from messages in each of the provided channels. Accepts multiple
 * channels as arguments, and emits an unsubscribe event for each unsubscribed
 * channel. The event is passed the channel name, and the current subscription
