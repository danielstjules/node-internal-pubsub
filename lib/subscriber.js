...
/**
 * Subscribes to all messages published in the given channels. Ignores any
 * channels are already subscribed to. Accepts multiple channels as arguments,
 * and emits subscribe event for each newly subscribed channel. The event
 * is passed the channel name, and the current subscription count.
 *
